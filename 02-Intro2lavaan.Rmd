...
Recall from [Chapter 1](#ch1) that:
...
This chapter will show how to fit a multigroup SEM to raw data as well as to summary statistics.  For the latter, we require group-specific summary statistics, which [Chapter 1](#ch1) discussed how to obtain:
