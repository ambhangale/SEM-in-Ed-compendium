...
```{r echo = FALSE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', label="fig27-1", fig.cap="Random intercept model for alcohol-use data from Duncan and Duncan (1996)."}
...
```{r echo = FALSE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', label="fig27-2", fig.cap="Linear growth model for alcohol-use data from Duncan and Duncan (1996)." }
...
```{r echo = FALSE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', label="fig27-3", fig.cap="Latent basis models for alcohol-use data from Duncan and Duncan (1996)."}
...
```{r echo = FALSE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', label="fig27-4", fig.cap="Saturated growth model for alcohol-use data from Duncan and Duncan (1996)." }
...
```{r echo = FALSE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', label="fig27-5", fig.align = "center", fig.cap="Linear growth model for alcohol-use data from Duncan and Duncan (1996) with subject-level predictors of growth factors." }
...
```{r echo = FALSE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', label="fig27-6", fig.align = "center", fig.cap="Linear growth model for alcohol-use data from Duncan and Duncan (1996), controlling for cigarette-use data." }
...
```{r echo = FALSE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', label="fig27-7", fig.align = "center", fig.cap="Curve-of-factors model for substance-use data from Duncan and Duncan (1996)." }
