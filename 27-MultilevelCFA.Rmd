# Fitting CFA models with multilevel data {#ch27}
...
[Script 27.2](#script-27.2) fits the multilevel factor model to the six conflict indicators, in which there is one factor underlying the indicator scores. Below you can find a graphical display of the model. 
```{r label="fig27-1", echo = FALSE, out.width = "80%", fig.align = "center", fig.cap="A two-level factor model on six conflict items." }
