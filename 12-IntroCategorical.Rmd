...
Consider the mediation model depicted in Figure \@ref(fig:fig12-1) below.  The dashed line is the direct effect of treatment on smoking behavior, given the intent to smoke.


```{r label="fig12-1", echo = FALSE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', fig.cap="Mediation model for smoking-intervention data from Duncan and Duncan (1996)."}
