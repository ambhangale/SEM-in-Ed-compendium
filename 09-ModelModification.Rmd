...
Note that there is also a slightly different formula available, which is implemented in Bentler’s (1995) EQS software.  Rather than standardizing each matrix with respect to their own SDs, then subtracting them, Bentler proposed subtracting the unstandardized covariance matrices, then standardizing the differences with respect to the observed-variable SDs only.  Script 8.2 shows how to request these correlation residuals from lavaan, as well as how the procedure to calculate them differs.
