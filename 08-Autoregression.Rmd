...
Script 8.2 fits an autoregression model, with second order autoregression effects, and ‘gender’ and ‘family status’ as predictors to the same data of Duncan and Duncan (1996) as in script 8.1. This model is depicted in Figure \@ref(fig:fig8-2).
