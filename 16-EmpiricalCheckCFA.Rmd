# The Empirical Check for Identification
...
- Step 1: Calculate a model-implied covariance matrix for the model you want to check.
...
In this chapter we will show two examples of the empirical check. We will first check identification of the factor model depicted in Figure 1a, and subsequently of the factor model depicted in Figure 1b.

16.1 Empirical check of Model A
