...
The $\chi^2$ test of exact fit is based on the maximum likelihood (ML) discrepancy function. When all assumptions are satisfied, $(N − 1) × \text{F}_{\text{ML}}$ has a central $\chi^2$ distribution:
